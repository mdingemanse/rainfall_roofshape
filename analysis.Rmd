...
Here is an approach implmented first in 'The ecology of religious beliefs' by Carlos Botero et. al. This approach includes language family as a random effect and estimates the potential effects of spatial proximity.

The original formulation of this approach includes the average socre among the N nearest neighbors for a given observation as a covariate in the model. However, since we are using a global sample, taking the nearest neighbours is contingent on distance. So here we alter this approach to take the nearest neighbours within a certain distance - in this case 1000km.
